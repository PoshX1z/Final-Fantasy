...
export const EditForm = ({ product }: { product: IProductInput }) => {
  ...
  const [form, setForm] = useState<IProductInput>({
    ...
    platformImageIcon: product.platformImageIcon,
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <Image src={product.image} alt={product.slug} width={300} height={300} />
